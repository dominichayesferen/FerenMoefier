...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Moebuntu Default wallpaper!") $(eval_gettext "Aborting now.")"
    exit 1
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Mari wallpaper! It's Not Joke.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Rikka uncovering Windows wallpaper!")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Rikka and Yuuta Fantasy wallpaper! Guess it was just a fantasy after all...")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Rikka at Train Station wallpaper!")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the CLANNAD wallpaper!")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Madoka Magica MCs wallpaper! That darn entropy, probably.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Best Madoka Magica Girl wallpaper! Being meguka is suffering.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Anohana wallpaper! Respect her privacy, I guess.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Windows 7 Waifu wallpaper! Leave her be now she graduated, SMH.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Windows 10 Waifu wallpaper! Probably too bloated to carry.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Yuuta wallpaper! Don't call him Dark Flame Master now, will ya?")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading another Chunibyo wallpaper! What delusional circumstances, eh.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "My apologies, I was crying too much to successfully download the Dango wallpaper.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Snow Halation wallpaper! You've escaped for now.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the K-On! wallpaper!")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading another Diary of Our Days at the Breakwater wallpaper!")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Your Name Mitsuha wallpaper! Something must have happened...")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading the Your Name 2 wallpaper! Swapping bodies in 3, 2, 1...")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Sorry, I was too busy trying not to cry that I didn't successfully download the Invisible Boundary Lines wallpaper.")"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading a CLANNAD After Story wallpaper!") ${RED}$(eval_gettext "Yet, the snow falls.")${NC}"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading another CLANNAD After Story wallpaper!") ${RED}$(eval_gettext "Something's gonna happen to that happy family, won't it?")${NC}"
    sleep 10
else
...
if [ ! $? -eq 0 ]; then
    echo "$(eval_gettext "Oops, an error occured downloading another anohana wallpaper!") ${RED}$(eval_gettext "Don't forget about her.")${NC}"
    sleep 10
else
